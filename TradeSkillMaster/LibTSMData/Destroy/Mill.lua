...
-- ============================================================================
-- Wrath (WotLK pigments, sourced from the Panda table)
-- ============================================================================

DATA.Wrath = {}
do
	-- WotLK-era pigment item IDs (common + uncommon). Cata (61979/61980) and
	-- MoP (79251/79253) pigments are excluded — those professions don't exist on 3.3.5.
	local WRATH_PIGMENTS = {
		"i:39151", "i:39334", "i:39338", "i:39339", "i:39340", "i:39341", "i:39342", "i:39343",
		"i:43103", "i:43104", "i:43105", "i:43106", "i:43107", "i:43108", "i:43109",
	}
	for _, pigment in ipairs(WRATH_PIGMENTS) do
		DATA.Wrath[pigment] = DATA.Panda[pigment]
	end
end
