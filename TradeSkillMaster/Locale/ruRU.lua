...
L["Could not sell items due to not having free bag space available to split a stack of items."] = "Недостат��чно места для разделения стака."
L["Craft"] = "Создать"
...
L["Item Selection"] = "Выбор пр��дмета"
...
L["Mailing operations control mailing to other characters."] = "Почтовые операци�� контролируют рассылку другим персонажам."
...
L["Performing a dry-run of your Mailing operations for the selected groups."] = "Пробный запу��к отправки для выбранных групп."
